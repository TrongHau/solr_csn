...
$.TokenList = function (input, url_or_data, settings) {
    ...
    var hidden_input_name = $(settings.setInputName)
                            .hide()
                            .val("");
    ...
    function update_hidden_input(saved_tokens, hidden_input) {
        ...
        if(hidden_input_name){
            var token_name = $.map(saved_tokens, function (el) {
                return el[settings.tokenName];
            });
            hidden_input_name.val(token_name.join(settings.tokenDelimiter));
        }
    ...
    if (typeof settings.addFunction() !== "undefined") {
        return settings.addFunction();
    }
};
