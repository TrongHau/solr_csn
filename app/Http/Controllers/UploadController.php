...
//            'choose_artist_avatar' => 'required|mimes:jpeg,bmp,png,gif|max:10000kb|file:1',
            'choose_artist_avatar' => 'required|max:10000kb|file:1',
            'artist_cover' => 'required',
//            'choose_artist_cover' => 'required|mimes:jpeg,bmp,png,gif|max:10000kb|file:1',
            'choose_artist_cover' => 'required|max:10000kb|file:1',
...
//                'music_album_id' => 'required',
            ...
            if($request->input('album_cover')) {
                ...
                $fileNameCovert = Helpers::saveBase64ImageJpg($request->input('album_cover'),
                    Helpers::file_path($album->cover_id, AVATAR_ALBUM_CROP_PATH, true),
                    $album->cover_id,
                    [
                        ['dest' => Helpers::file_path($album->cover_id, AVATAR_ALBUM_THUMB_CROP_PATH, true), 'width' => 100, 'height' => null],
                        ['dest' => Helpers::file_path($album->cover_id, AVATAR_ALBUM_THUMB_200_CROP_PATH, true), 'width' => 100, 'height' => null]
                    ]
                );
...
//            'album_music_total' => count($fileUploads),
        ...
        $fileNameCovert = Helpers::saveBase64ImageJpg($request->input('album_cover'),
            ...
            [
                ['dest' => Helpers::file_path($album->cover_id, AVATAR_ALBUM_THUMB_CROP_PATH, true), 'width' => 100, 'height' => null],
                ['dest' => Helpers::file_path($album->cover_id, AVATAR_ALBUM_THUMB_200_CROP_PATH, true), 'width' => 200, 'height' => null]
            ]
        );
        if($album->cover_filename)
            Storage::disk('public')->delete(Helpers::file_path($album->cover_id, COVER_ALBUM_SOURCE_PATH, true).$album->cover_filename);
