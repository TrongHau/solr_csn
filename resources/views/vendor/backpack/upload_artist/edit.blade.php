                        ...
                        @if($fields['type']['value'] == 0)
                            <div class="form-group col-xs-6">
                                ...
                                <div class="form-group col-xs-4">
                                    <label style="display: -webkit-box;">Avatar</label>
                                    <img class="mr-3" style="width: 100%"id="artist_avatar_uploaded" src="{{$artist_exists['artist_avatar'] ? env('DATA_URL').Helpers::file_path($artist_exists['artist_id'], AVATAR_ARTIST_CROP_PATH, true).$artist_exists['artist_avatar'].'?time='.time() : '/imgs/avatar_default.png'}}" alt="">
                                </div>
                                <div class="form-group col-xs-9" style="margin-top: 50px;">
                                    <label style="display: -webkit-box;">Cover</label>
                                    <img class="mr-3" style="width: 100%" id="artist_cover_uploaded" src="{{$artist_exists['artist_cover'] ? env('DATA_URL').Helpers::file_path($artist_exists['artist_id'], COVER_ARTIST_CROP_PATH, true).$artist_exists['artist_cover'].'?time='.time() : '/imgs/avatar_default.png'}}" alt="">
                                </div>
                            </div>
                        @endif
                    </div><!-- /.box-body -->
