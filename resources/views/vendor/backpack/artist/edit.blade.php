                ...
                <div class="box">
                    ...
                    <div class="box-body row display-flex-wrap" style="display: flex;flex-wrap: wrap;">
                        ...
                        <div class="form-group col-xs-4">
                            ...
                            <img class="mr-3" style="width: 100%" id="artist_avatar_uploaded" src="{{$fields['artist_avatar']['value'] ? env('DATA_URL').Helpers::file_path($fields['id']['value'], AVATAR_ARTIST_CROP_PATH, true).$fields['artist_avatar']['value'].'?time='.time() : '/imgs/avatar_default.png'}}" alt="">
